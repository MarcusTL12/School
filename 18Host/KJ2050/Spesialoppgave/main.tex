...
\usepackage{chemfig, amssymb, marvosym, textcomp}
\setangleincrement{1}
\setatomsep{2em}
\setbondstyle{line width = 0.8pt}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Lager headeren
\lhead{A. Steen, S. E. D. Olsen, D. R. Olsen, \\ E. T. Hoff, M. T. Lexander}
\chead{}
\rhead{KJ2050 -- Analytisk kjemi laboratoriekurs  \\ \today}	
\lfoot{}
\cfoot{\thepage}												
\rfoot{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \signature{Trondheim}{Marcus Takvam Lexander} % lager en signaturlinje.

\bibliographystyle{ieeetr}%Definerer bibliografistil
